...
class RNAGame {
  ...
  //   const textX = (250 - alertText.width()) / 2;
  //   const textY = (250 - alertText.height()) / 2;

  //   alertText.position({ x: textX, y: textY });
  ...
  //   // Close button pointerclick event
  //   closeButton.on("pointerclick", () => {
  //     alertBox.destroy(); // Remove alert box
  //     this.alertLayer.batchDraw(); // Redraw the UI layer
  //   });
